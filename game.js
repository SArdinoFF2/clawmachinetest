...
const RARE_ODDS = .25
const COMMON_ODDS = .1
const UNCOMMON_ODDS = .04
const UNIQUE_ODDS = .125
const LEGENDARY_ODDS = .005
const LOSING_ODDS = 1 - ((COMMON_ODDS*6) + (UNCOMMON_ODDS*5) + (RARE_ODDS*6) + (UNIQUE_ODDS*2) + LEGENDARY_ODDS) 
var winningOdds = {0:LEGENDARY_ODDS,1:UNIQUE_ODDS,2:UNIQUE_ODDS,3:RARE_ODDS,4:RARE_ODDS,5:RARE_ODDS,6:RARE_ODDS,7:RARE_ODDS,8:RARE_ODDS,9:UNCOMMON_ODDS,10:UNCOMMON_ODDS,11:UNCOMMON_ODDS,12:UNCOMMON_ODDS,13:UNCOMMON_ODDS,14:COMMON_ODDS,15:COMMON_ODDS,16:COMMON_ODDS,17:COMMON_ODDS,18:COMMON_ODDS,19:COMMON_ODDS,20:.2}
